...
// performance = globalMy.proxy(performance,"performance")
// navigation =globalMy.proxy(navigation,"navigation")
// indexedDB = globalMy.proxy(indexedDB,"indexedDB");
// self = globalMy.proxy(self,"self");
// history = globalMy.proxy (history);
